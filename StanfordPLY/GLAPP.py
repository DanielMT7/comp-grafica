...
class GLAPP(ABC):
    def __init__(self):
        ...
        self.window = sdl2.SDL_CreateWindow("Gráficos".encode("utf-8"), sdl2.SDL_WINDOWPOS_CENTERED, sdl2.SDL_WINDOWPOS_CENTERED,
                                            self.width, self.height, sdl2.SDL_WINDOW_OPENGL | sdl2.SDL_WINDOW_RESIZABLE | sdl2.SDL_WINDOW_HIDDEN)
        if not self.window:
    ...
    def loadTexture(self, filename):
        ...
        GL.glTexImage2D(GL.GL_TEXTURE_2D, 0, modo, w, h, 0,

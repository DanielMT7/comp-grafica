...
import glm
import math
from StanfordDragon import *
a = 0


class StanfordDragonApp(GLAPP):

    def setup(self):
        self.title("Stanford Dragon")
        self.size(800, 800)
        ...
        self.pipeline = self.loadPipeline("IntensityForDragon")
        GL.glUseProgram(self.pipeline)

        self.dragon = StanfordDragon()
    ...
    def draw(self):
        ...
        camera = glm.lookAt(glm.vec3(0, 2, 6), glm.vec3(
            0, 2, 2), glm.vec3(0, 1, 0))
